...
public class ResId {
    ...
    public static class string {
        ...
        public static int deleted_messages;
        ...
        public static int hideread_sum;
        public static int hidestatusview;
        public static int hidestatusview_sum;
        public static int hidereceipt;
        public static int hidereceipt_sum;
        public static int ghostmode;
        public static int ghostmode_sum;
        public static int ghostmode_r;
        public static int ghostmode_sum_r;
        public static int blueonreply;
        public static int blueonreply_sum;
        public static int custom_privacy;
        public static int custom_privacy_sum;
        public static int block_call;
        public static int call_blocker_sum;
        public static int custom_privacy_global_status;
