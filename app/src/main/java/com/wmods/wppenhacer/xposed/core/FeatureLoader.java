...
import com.wmods.wppenhacer.xposed.features.others.AutoReply;
...
public class FeatureLoader {
    ...
    public static void start(@NonNull ClassLoader loader, @NonNull XSharedPreferences pref, String sourceDir,
        ...
        XposedBridge.log("WaEnhancer: FeatureLoader.start called for package: "
                + (lpparam != null ? lpparam.packageName : "null"));
                ...
                new XC_MethodHook() {
                    ...
                    protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                        ...
                        try {
                            ...
                            // XposedHelpers.setStaticIntField(XposedHelpers.findClass("com.whatsapp.util.Log",
                            // loader), "level", 5);
                            ...
                            XposedBridge.log(e);
                            ErrorDialogManager.addError(ErrorDialogManager.createError("MainFeatures[Critical]",
                                    packageInfo.versionName, e));
                        }
